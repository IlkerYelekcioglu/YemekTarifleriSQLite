...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let  {
            ...
            if(gelenBilgi.equals("menudengeldim")){
                ...
                var gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources,R.drawable.gorselsecimi)
                imageView.setImageBitmap(gorselSecmeArkaPlani)
            }else{
                //dahaönce oluşturulan yemeğe geldi
    ...
    fun kaydet(view: View) {
     //SQLite kaydetme
        ...
        var yemekMalzeme = yemekMalzemeText.text.toString()
